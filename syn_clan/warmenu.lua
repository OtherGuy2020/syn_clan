...
local k_delay2 = 160 -- puis 2 3 et 4Ă¨me delay
local k_delay3 = 130 -- et si touche restĂ©e appuyĂ©e.

function isPressedKey(key)
	if key ~= lastKey and IsDisabledControlPressed(1, key) then -- Pas la mĂŞme touche -> RESET
		lastKey = key
		timer = GetGameTimer()
		count = 0
		pass = false
	...
	elseif key == lastKey and IsDisabledControlPressed(1, key) then -- Meme Touche
		if pass then 										-- AccĂ©lĂ©ration du dĂ©filement
			count = 0
